      ...
      <div class="card-body card-block">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" id="product_name" name="product[name]" placeholder="Text" class="form-control" value="{{ $product->name }}" />
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <select id="product_client_id" name="product[client_id]" class="form-control">
                @foreach ($clients as $c)
                    <option value="{{ $c->id }}" {{ $c->id == $product->client_id ? 'selected' : null }}>{{ $c->name }}</option>
                @endforeach
                 </select>
            </div>
          </div>
